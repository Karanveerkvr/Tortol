function message() {
const message = 'happy  burpday  Tortol',
   messageText = document.querySelectorAll(".message__text"),
   messageSplit = message.split(""),
   tTortol = document.getElementById("turt"),
   tSon = document.getElementById("son"),
   tKetch = document.getElementById("ketch"),
   tH1 = document.getElementById("h1t"),
      messageContainer = document.querySelector(".message"),
      messageBtn = document.querySelector(".message__btn"),
      reloadBtn = document.querySelector(".reload"),
      particlesContainer = document.getElementById("particles-js");

const colors = ["#52b788", "#2d6a4f", "#74c69d", "#40916c", "#95d5b2"];
let i = 0;
...
let myAudio = new Audio('music/hbd.mp3'); 
...
function openMessage() {
       if(messageContainer.classList.contains("clicked")) {
          ...
          myAudio.pause();
          tTortol.classList.add("tNone");
          tSon.classList.add("tNone");
          tKetch.classList.add("tNone");
          tH1.classList.add("tNone");
       } else {
         myAudio.play();
        ...
        tTortol.classList.remove("tNone");
        tSon.classList.remove("tNone");
        tKetch.classList.remove("tNone");
        tH1.classList.remove("tNone");
       }
}
...
particlesJS("particles-js", {
   particles: {
      ...
      color: { value: ["#95d5b2", "#74c69d", "#52b788", "#40916c", "#1b4332", "#ffffff", "#cc444b", "#ff6b6b","#e63946" ] },
      shape: {
         type: "circle",
